...
INSERT INTO `pt_attribute` (`attribute_id`, `attribute_group_id`, `sort_order`) VALUES
(1, 6, 1),
(2, 6, 5),
(3, 6, 3),
(4, 3, 1),
...
--
-- Dumping data for table `pt_attribute_description`
--

INSERT INTO `pt_attribute_description` (`attribute_id`, `language_id`, `name`) VALUES
(1, 1, 'Description'),
(2, 1, 'No. of Cores'),
(4, 1, 'test 1'),
(5, 1, 'test 2'),
...
--
-- Dumping data for table `pt_attribute_group`
--

INSERT INTO `pt_attribute_group` (`attribute_group_id`, `sort_order`) VALUES
(3, 2),
(4, 1),
(5, 3),
(6, 4);
...
--
-- Dumping data for table `pt_attribute_group_description`
--

INSERT INTO `pt_attribute_group_description` (`attribute_group_id`, `language_id`, `name`) VALUES
(3, 1, 'Memory'),
(4, 1, 'Technical'),
(5, 1, 'Motherboard'),
(6, 1, 'Processor');
...
INSERT INTO `pt_category` (`category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- Dumping data for table `pt_category_description`
--

INSERT INTO `pt_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
...
--
-- Dumping data for table `pt_category_path`
--

INSERT INTO `pt_category_path` (`category_id`, `path_id`, `level`) VALUES
(25, 25, 0),
(28, 25, 0),
(28, 28, 1),
(35, 25, 0),
...
--
-- Dumping data for table `pt_category_to_store`
--

INSERT INTO `pt_category_to_store` (`category_id`, `store_id`) VALUES
(17, 0),
(18, 0),
(20, 0),
(24, 0),
...
INSERT INTO `pt_coupon` (`coupon_id`, `name`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`) VALUES
...
--
-- Dumping data for table `pt_cron`
--

INSERT INTO `pt_cron` (`cron_id`, `code`, `cycle`, `action`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- Dumping data for table `pt_currency`
--

INSERT INTO `pt_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
...
INSERT INTO `pt_customer_group` (`customer_group_id`, `approval`, `sort_order`) VALUES
(1, 0, 1);

-----------------------------------------------------------

--
-- Dumping data for table `pt_customer_group_description`
--

INSERT INTO `pt_customer_group_description` (`customer_group_id`, `language_id`, `name`, `description`) VALUES
(1, 1, 'Default', 'test');

-----------------------------------------------------------

--
-- Dumping data for table `pt_custom_field`
--

INSERT INTO `pt_custom_field` (`custom_field_id`, `type`, `value`, `validation`, `location`, `status`, `sort_order`) VALUES
...
--
-- Dumping data for table `pt_custom_field_customer_group`
--

INSERT INTO `pt_custom_field_customer_group` (`custom_field_id`, `customer_group_id`, `required`) VALUES
(1, 1, 1),
(2, 1, 1),
(3, 1, 1),
(4, 1, 1),
...
--
-- Dumping data for table `pt_custom_field_description`
--

INSERT INTO `pt_custom_field_description` (`custom_field_id`, `language_id`, `name`) VALUES
(1, 1, 'Select'),
(2, 1, 'Radio'),
(3, 1, 'Checkbox'),
(4, 1, 'Text'),
...
--
-- Dumping data for table `pt_custom_field_value`
--

INSERT INTO `pt_custom_field_value` (`custom_field_value_id`, `custom_field_id`, `sort_order`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 2, 1),
...
--
-- Dumping data for table `pt_custom_field_value_description`
--

INSERT INTO `pt_custom_field_value_description` (`custom_field_value_id`, `language_id`, `custom_field_id`, `name`) VALUES
(1, 1, 1, 'Test 1'),
(2, 1, 1, 'test 2'),
(3, 1, 1, 'Test 3'),
(4, 1, 2, 'Test 1'),
...
--
-- Dumping data for table `pt_extension`
--

INSERT INTO `pt_extension` (`extension_id`, `type`, `code`) VALUES
(1, 'payment', 'cod'),
(2, 'total', 'shipping'),
(3, 'total', 'sub_total'),
(4, 'total', 'tax'),
...
--
-- Dumping data for table `pt_geo_zone`
--

INSERT INTO `pt_geo_zone` (`geo_zone_id`, `name`, `description`, `date_modified`, `date_added`) VALUES
...
--
-- Dumping data for table `pt_information_to_store`
--

INSERT INTO `pt_information_to_store` (`information_id`, `store_id`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Dumping data for table `pt_layout`
--

INSERT INTO `pt_layout` (`layout_id`, `name`) VALUES
(1, 'Home'),
(2, 'Product'),
(3, 'Category'),
(4, 'Default'),
...
--
-- Dumping data for table `pt_layout_module`
--

INSERT INTO `pt_layout_module` (`layout_module_id`, `layout_id`, `code`, `position`, `sort_order`) VALUES
(2, 4, '0', 'content_top', 0),
(3, 4, '0', 'content_top', 1),
...
--
-- Dumping data for table `pt_layout_route`
--

INSERT INTO `pt_layout_route` (`layout_route_id`, `layout_id`, `store_id`, `route`) VALUES
(1, 6, 0, 'account/%'),
...
--
-- Dumping data for table `pt_length_class`
--

INSERT INTO `pt_length_class` (`length_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '10.00000000'),
(3, '0.39370000');
...
--
-- Dumping data for table `pt_length_class_description`
--

INSERT INTO `pt_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Centimeter', 'cm'),
(2, 1, 'Millimeter', 'mm'),
(3, 1, 'Inch', 'in');
...
--
-- Dumping data for table `pt_manufacturer`
--

INSERT INTO `pt_manufacturer` (`manufacturer_id`, `name`, `image`, `sort_order`) VALUES
...
--
-- Dumping data for table `pt_manufacturer_to_store`
--

INSERT INTO `pt_manufacturer_to_store` (`manufacturer_id`, `store_id`) VALUES
(5, 0),
(6, 0),
(7, 0),
(8, 0),
...
INSERT INTO `pt_module` (`module_id`, `name`, `code`, `setting`) VALUES
...
INSERT INTO `pt_option` (`option_id`, `type`, `sort_order`) VALUES
(1, 'radio', 1),
(2, 'checkbox', 2),
(4, 'text', 3),
(5, 'select', 4),
...
--
-- Dumping data for table `pt_option_description`
--

INSERT INTO `pt_option_description` (`option_id`, `language_id`, `name`) VALUES
(1, 1, 'Radio'),
(2, 1, 'Checkbox'),
(4, 1, 'Text'),
(6, 1, 'Textarea'),
...
--
-- Dumping data for table `pt_option_value`
--

INSERT INTO `pt_option_value` (`option_value_id`, `option_id`, `image`, `sort_order`) VALUES
(43, 1, '', 3),
(32, 1, '', 1),
(45, 2, '', 4),
(44, 2, '', 3),
...
--
-- Dumping data for table `pt_option_value_description`
--

INSERT INTO `pt_option_value_description` (`option_value_id`, `language_id`, `option_id`, `name`) VALUES
(43, 1, 1, 'Large'),
(32, 1, 1, 'Small'),
(45, 1, 2, 'Checkbox 4'),
(44, 1, 2, 'Checkbox 3'),
...
--
-- Dumping data for table `pt_shipping_courier`
--

INSERT INTO `pt_shipping_courier` (`shipping_courier_id`, `shipping_courier_code`, `shipping_courier_name`) VALUES
  (1, 'dhl', 'DHL'),
  (2, 'fedex', 'Fedex'),
  (3, 'ups', 'UPS'),
...
--
-- Dumping data for table `pt_order_status`
--

INSERT INTO `pt_order_status` (`order_status_id`, `language_id`, `name`) VALUES
(2, 1, 'Processing'),
(3, 1, 'Shipped'),
(7, 1, 'Canceled'),
(5, 1, 'Complete'),
...
--
-- Dumping data for table `pt_product`
--

INSERT INTO `pt_product` (`product_id`, `model`, `sku`, `upc`, `ean`, `jan`, `isbn`, `mpn`, `location`, `quantity`, `stock_status_id`, `image`, `manufacturer_id`, `shipping`, `price`, `points`, `tax_class_id`, `date_available`, `weight`, `weight_class_id`, `length`, `width`, `height`, `length_class_id`, `subtract`, `minimum`, `sort_order`, `status`, `viewed`, `date_added`, `date_modified`) VALUES
...
--
-- Dumping data for table `pt_product_attribute`
--

INSERT INTO `pt_product_attribute` (`product_id`, `attribute_id`, `language_id`, `text`) VALUES
(43, 2, 1, '1'),
(47, 4, 1, '16GB'),
(43, 4, 1, '8gb'),
(42, 3, 1, '100mhz'),
...
--
-- Dumping data for table `pt_product_description`
--

INSERT INTO `pt_product_description` (`product_id`, `language_id`, `name`, `description`, `tag`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(35, 1, 'Product 8', '&lt;p&gt;\r\n	Product 8&lt;/p&gt;\r\n', '', 'Product 8', '', ''),
...
--
-- Dumping data for table `pt_product_discount`
--

INSERT INTO `pt_product_discount` (`product_discount_id`, `product_id`, `customer_group_id`, `quantity`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- Dumping data for table `pt_product_image`
--

INSERT INTO `pt_product_image` (`product_image_id`, `product_id`, `image`, `sort_order`) VALUES
...
--
-- Dumping data for table `pt_product_option`
--

INSERT INTO `pt_product_option` (`product_option_id`, `product_id`, `option_id`, `value`, `required`) VALUES
(224, 35, 11, '', 1),
...
--
-- Dumping data for table `pt_product_option_value`
--

INSERT INTO `pt_product_option_value` (`product_option_value_id`, `product_option_id`, `product_id`, `option_id`, `option_value_id`, `quantity`, `subtract`, `price`, `price_prefix`, `points`, `points_prefix`, `weight`, `weight_prefix`) VALUES
...
--
-- Dumping data for table `pt_product_related`
--

INSERT INTO `pt_product_related` (`product_id`, `related_id`) VALUES
(40, 42),
(41, 42),
(42, 40),
(42, 41);
...
--
-- Dumping data for table `pt_product_reward`
--

INSERT INTO `pt_product_reward` (`product_reward_id`, `product_id`, `customer_group_id`, `points`) VALUES
(515, 42, 1, 100),
(519, 47, 1, 300),
(379, 28, 1, 400),
(329, 43, 1, 600),
...
--
-- Dumping data for table `pt_product_special`
--

INSERT INTO `pt_product_special` (`product_special_id`, `product_id`, `customer_group_id`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- Dumping data for table `pt_product_to_category`
--

INSERT INTO `pt_product_to_category` (`product_id`, `category_id`) VALUES
(28, 20),
(28, 24),
(29, 20),
(29, 24),
...
--
-- Dumping data for table `pt_product_to_store`
--

INSERT INTO `pt_product_to_store` (`product_id`, `store_id`) VALUES
(28, 0),
(29, 0),
(30, 0),
(31, 0),
...
--
-- Dumping data for table `pt_return_action`
--

INSERT INTO `pt_return_action` (`return_action_id`, `language_id`, `name`) VALUES
(1, 1, 'Refunded'),
(2, 1, 'Credit Issued'),
...
--
-- Dumping data for table `pt_return_reason`
--

INSERT INTO `pt_return_reason` (`return_reason_id`, `language_id`, `name`) VALUES
(1, 1, 'Dead On Arrival'),
...
--
-- Dumping data for table `pt_return_status`
--

INSERT INTO `pt_return_status` (`return_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
(3, 1, 'Complete'),
...
--
-- Dumping data for table `pt_statistics`
--

INSERT INTO `pt_statistics` (`statistics_id`, `code`, `value`) VALUES
(1, 'order_sale', 0),
...
--
-- Dumping data for table `pt_stock_status`
--

INSERT INTO `pt_stock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(7, 1, 'In Stock'),
(8, 1, 'Pre-Order'),
(5, 1, 'Out Of Stock'),
(6, 1, '2-3 Days');
...
--
-- Dumping data for table `pt_tax_class`
--

INSERT INTO `pt_tax_class` (`tax_class_id`, `title`, `description`, `date_added`, `date_modified`) VALUES
...
--
-- Dumping data for table `pt_tax_rate`
--

INSERT INTO `pt_tax_rate` (`tax_rate_id`, `geo_zone_id`, `name`, `rate`, `type`, `date_added`, `date_modified`) VALUES
...
--
-- Dumping data for table `pt_tax_rate_to_customer_group`
--

INSERT INTO `pt_tax_rate_to_customer_group` (`tax_rate_id`, `customer_group_id`) VALUES
(86, 1),
(87, 1);
...
--
-- Dumping data for table `pt_tax_rule`
--

INSERT INTO `pt_tax_rule` (`tax_rule_id`, `tax_class_id`, `tax_rate_id`, `based`, `priority`) VALUES
(121, 10, 86, 'payment', 1),
(120, 10, 87, 'store', 0),
(128, 9, 86, 'shipping', 1),
(127, 9, 87, 'shipping', 2);
...
--
-- Dumping data for table `pt_voucher_theme`
--

INSERT INTO `pt_voucher_theme` (`voucher_theme_id`, `image`) VALUES
...
--
-- Dumping data for table `pt_voucher_theme_description`
--

INSERT INTO `pt_voucher_theme_description` (`voucher_theme_id`, `language_id`, `name`) VALUES
(6, 1, 'Christmas'),
(7, 1, 'Birthday'),
(8, 1, 'General');
...
--
-- Dumping data for table `pt_weight_class`
--

INSERT INTO `pt_weight_class` (`weight_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '1000.00000000'),
(5, '2.20460000'),
(6, '35.27400000');
...
--
-- Dumping data for table `pt_weight_class_description`
--

INSERT INTO `pt_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Kilogram', 'kg'),
(2, 1, 'Gram', 'g'),
(5, 1, 'Pound ', 'lb'),
(6, 1, 'Ounce', 'oz');
...
--
-- Dumping data for table `pt_zone_to_geo_zone`
--

INSERT INTO `pt_zone_to_geo_zone` (`zone_to_geo_zone_id`, `country_id`, `zone_id`, `geo_zone_id`, `date_added`, `date_modified`) VALUES
